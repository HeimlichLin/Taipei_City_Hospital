...
public class BunqiaoActivity extends AppCompatActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bunqiao);
        ...
        btnBanqiao.setBackgroundColor(Color.LTGRAY);
        btnBanqiao.setTextColor(Color.BLACK);
