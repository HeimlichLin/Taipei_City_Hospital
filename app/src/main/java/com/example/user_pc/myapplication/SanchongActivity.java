...
public class SanchongActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSanchong.setBackgroundColor(Color.LTGRAY);
        btnSanchong.setTextColor(Color.BLACK);
